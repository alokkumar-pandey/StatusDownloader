package com.alokpandey.stat.whatsappvideo;
...
import com.alokpandey.stat.GalleryVideoActivity;
import com.alokpandey.stat.R;
import com.alokpandey.stat.ShowVideo;
import com.alokpandey.stat.StaticVariables;
import com.alokpandey.stat.whatsappimages.ImagesAlbum;
...
public class VideosDownload extends Fragment implements
        ...
        if (file.isDirectory()) {
            ...
            for (File aListFile : listFile) {
                if (!aListFile.getName().contains(".jpg")) {
                    FilePathStrings.add(aListFile.getAbsolutePath());
                    FileNameStrings.add(aListFile.getName());
                }
            }
        }
    ...
    private ArrayList<ImagesAlbum> getAlbumvideos() {
        ArrayList<ImagesAlbum> paths = new ArrayList<>();
    ...
    private void toggleSelection(int position) {
        ...
        org_path = uriPath.getPath();
        flag = 1;
        File imageFile = new File(Objects.requireNonNull(org_path));
